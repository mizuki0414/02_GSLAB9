...
function showResult(result) {
  //表情分析の結果の表示
  //   console.log(result);
  //   console.log(result.responses[0].faceAnnotations[0].joyLikelihood);
  //   console.log(result.responses[0].faceAnnotations[0].sorrowLikelihood);
  //   console.log(result.responses[0].faceAnnotations[0].angerLikelihood);
  //   console.log(result.responses[0].faceAnnotations[0].surpriseLikelihood);
  //   console.log(result.responses[0].faceAnnotations[0].headwearLikelihood);
  if (result.responses[0].faceAnnotations) {
    ...
    //チャート描画の処理
    const chartHTML = $("<li></li>");
    chartHTML.highcharts({
      chart: {
        polar: true,
        type: "area",
